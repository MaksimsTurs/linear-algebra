...
#define DEFINE_VEC2_FUNC(type, prefix, subtype) \
  INLINE f64_t     prefix##_length(type a)             { return sqrtl(a.x * a.x + a.y * a.y); } \
...
#define DEFINE_VEC2_FUNC_CONST(type, prefix, subtype) \
  INLINE f64_t     prefix##_length(const type* a)             { return sqrtl((a)->x * (a)->x + (a)->y * (a)->y); } \
...
#define DEFINE_VEC3_FUNC(type, prefix, subtype) \
  INLINE f64_t     prefix##_length(type a)             { return sqrtl(a.x * a.x + a.y * a.y + a.z * a.z); }\
...
#define DEFINE_VEC3_FUNC_CONST(type, prefix, subtype) \
  INLINE f64_t     prefix##_length(const type* a)             { return sqrtl((a)->x * (a)->x + (a)->y * (a)->y + (a)->z * (a)->z); } \
